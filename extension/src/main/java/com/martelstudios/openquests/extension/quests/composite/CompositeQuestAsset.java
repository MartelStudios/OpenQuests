...
/**
 * Config for a composite quest: the {@link OpenQuestAsset}s its children are created from, and how
 ...
 */
public class CompositeQuestAsset extends OpenQuestAsset {

    public static final BuilderCodec<CompositeQuestAsset> CODEC = BuilderCodec.builder(CompositeQuestAsset.class, CompositeQuestAsset::new, OpenQuestAsset.BASE_CODEC)
                                                                            .append(new KeyedCodec<>("QuestAssetIds", new ArrayCodec<>(new ContainedAssetCodec<>(OpenQuestAsset.class, OpenQuestAsset.CODEC), String[]::new)), (asset, ids) -> asset.assetIds = ids, asset -> asset.assetIds)
