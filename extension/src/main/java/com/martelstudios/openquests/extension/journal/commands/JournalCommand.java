 ...
 * to come back to, and the page follows from {@link QuestJournalUIService} hearing about the move.
 */
public class JournalCommand extends AbstractPlayerCommand {

    public JournalCommand() {
        super("quests", "Opens your quest journal");
        this.addAliases("journal");
    }
